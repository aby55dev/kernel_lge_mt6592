...
int g_dram_rank_count = 0;
unsigned long g_1st_rank_saddr = 0;
unsigned long g_1st_rank_size = 0;
#endif
...
#if defined(CONFIG_MACH_LGE)
            if(g_dram_rank_count == 0) {
                g_1st_rank_saddr = tags->u.mem.start;
                g_1st_rank_size = tags->u.mem.size;
            }
            printk("[RANK%d] start:0x%08x size:0x%08x\n", g_dram_rank_count,tags->u.mem.start,tags->u.mem.size);
            g_dram_rank_count++;
#endif
        }
...
/* LGE_S [seongjo.kim@lge.com] 2014/02/14, Add LaserSensor For LDAF */
//
/*=======================================================================*/
/* Laser sensor                                                        */
/*=======================================================================*/
static struct platform_device laser_dev = {
	.name		  = "laser_sensor",
	.id		  = -1,
};
/* LGE_E [seongjo.kim@lge.com] 2014/02/14, Add LaserSensor For LDAF */
/*=======================================================================*/
/* MT6575 jogball                                                        */
/*=======================================================================*/
...
// Laser sensor
//=======================================================================
#if 1  //defined(CONFIG_MTK_LASER)
    retval = platform_device_register(&laser_dev);
    if (retval != 0){
        return retval;
    }
#endif
