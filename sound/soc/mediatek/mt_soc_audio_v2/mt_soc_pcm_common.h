...
extern unsigned int soc_fm_supported_sample_rates[3];

extern unsigned int soc_voice_supported_sample_rates[3];

/* Conventional and unconventional sample rate supported */
extern unsigned int soc_normal_supported_sample_rates[9];

/* Conventional and unconventional sample rate supported */
extern unsigned int soc_high_supported_sample_rates[13];
