...
unsigned int soc_fm_supported_sample_rates[] =
{
    32000,44100,48000
};

unsigned int soc_voice_supported_sample_rates[] =
{
    8000,16000,32000
};

/* Conventional and unconventional sample rate supported */
unsigned int soc_normal_supported_sample_rates[] =
{
    8000, 11025, 12000, 16000, 22050, 24000, 32000,44100,48000
};

/* Conventional and unconventional sample rate supported */
unsigned int soc_high_supported_sample_rates[] =
{
