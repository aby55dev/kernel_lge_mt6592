...
int charging_ic_set_chargingmode( enum charging_ic_charging_mode mode ) 
{
    ...
    /*
    {
        ...
        printk( "[charger_rt9536] ::idx = %3d: mode = %d, pullsel = %d, dout = %d, pullen = %d, dir = %d\n", 
...
void charging_ic_set_ta_mode(void)
{
    ...
    printk( "[charger_rt9536] :: charging_ic_set_ta_mode\n");
...
void charging_ic_set_factory_mode(void)
{
    ...
    printk( "[charger_rt9536] :: charging_ic_set_factory_mode\n");
