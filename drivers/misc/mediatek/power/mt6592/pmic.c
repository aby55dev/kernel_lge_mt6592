...
void ext_buck_init_for_platform(void)
{
    ...
    else
    {
            ...
            xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[ext_buck_init_for_platform] CONFIG_IS_VCORE_USE_6333VCORE=y, nothing for internal VPROC.\n");
            //add setting id needed
        #else
            xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[ext_buck_init_for_platform] CONFIG_IS_VCORE_USE_6333VCORE=n, nothing for internal VPROC.\n");
            //add setting id needed
        #endif
    }
}
