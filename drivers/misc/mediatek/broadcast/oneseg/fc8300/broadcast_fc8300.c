...
#if defined(CONFIG_ARCH_MT6582) || defined(CONFIG_ARCH_MT6592)  // MediaTek platform
...
#endif //defined(CONFIG_ARCH_MT6582) || defined(CONFIG_ARCH_MT65892)// MediaTek platform
...
//#define MTK_PMIC_LNA    // MediaTek PMIC LNA Enable
...
void tunerbb_drv_hw_setting(void)
{
    ...
    //DTV LDO EN
    print_log(0,"[1seg][MTK] GPIO_FULL_SEG_LDO_EN Port request!!!\n");
...
#if defined(MTK_PMIC_LNA) && defined(TARGET_MT6592M_P1S3G)
    if(lge_get_board_revno() == HW_REV_B)
    {
        // LNA_PON
        ret = mt_set_gpio_pull_enable(GPIO_FULL_SEG_LNA_PON, GPIO_PULL_ENABLE);
        print_log(0,"[1seg][MTK] mt_set_gpio_pull_enable(GPIO_FULL_SEG_LNA_PON, GPIO_PULL_ENABLE) : (%d)\n", ret);
        ret = mt_set_gpio_pull_select(GPIO_FULL_SEG_LNA_PON, GPIO_PULL_DOWN);
        print_log(0,"[1seg][MTK] mt_set_gpio_pull_select(GPIO_FULL_SEG_LNA_PON, GPIO_PULL_DOWN) : (%d)\n", ret);
        ret = mt_set_gpio_dir(GPIO_FULL_SEG_LNA_PON, GPIO_DIR_OUT);
        print_log(0,"[1seg][MTK] mt_set_gpio_dir(GPIO_FULL_SEG_LNA_PON, GPIO_DIR_OUT) : (%d)\n", ret);
        ret = mt_set_gpio_out(GPIO_FULL_SEG_LNA_PON, GPIO_OUT_ZERO);
        print_log(0,"[1seg][MTK] mt_set_gpio_out(GPIO_FULL_SEG_LNA_PON, GPIO_OUT_ZERO) : (%d)\n", ret);

        // LNA_EN
        ret = mt_set_gpio_pull_enable(GPIO_FULL_SEG_LNA_EN, GPIO_PULL_ENABLE);
        print_log(0,"[1seg][MTK] mt_set_gpio_pull_enable(GPIO_FULL_SEG_LNA_EN, GPIO_PULL_ENABLE) : (%d)\n", ret);
        ret = mt_set_gpio_pull_select(GPIO_FULL_SEG_LNA_EN, GPIO_PULL_DOWN);
        print_log(0,"[1seg][MTK] mt_set_gpio_pull_select(GPIO_FULL_SEG_LNA_EN , GPIO_PULL_DOWN) : (%d)\n", ret);
        ret = mt_set_gpio_dir(GPIO_FULL_SEG_LNA_EN, GPIO_DIR_OUT);
        print_log(0,"[1seg][MTK] mt_set_gpio_dir(GPIO_FULL_SEG_LNA_EN, GPIO_DIR_OUT) : (%d)\n", ret);
        ret = mt_set_gpio_out(GPIO_FULL_SEG_LNA_EN, GPIO_OUT_ZERO);
        print_log(0,"[1seg][MTK] mt_set_gpio_out(GPIO_FULL_SEG_LNA_EN, GPIO_OUT_ZERO) : (%d)\n", ret);
    }
#endif //defined(MTK_PMIC_LNA)
...
#else //defined(CONFIG_ARCH_MT6582) || defined(CONFIG_ARCH_MT6592)
...
#endif //defined(CONFIG_ARCH_MT6582) || defined(CONFIG_ARCH_MT6592)
}
...
{
    int ret;
#if defined(CONFIG_ARCH_MT6582) || defined(CONFIG_ARCH_MT6592)
...
// MediaTek platform
    ...
    if(lge_get_board_revno() == HW_REV_B)
    {
        ret = mt_set_gpio_out(GPIO_FULL_SEG_LNA_PON, GPIO_OUT_ONE);
        print_log(0,"[1seg][MTK] mt_set_gpio_out(GPIO_FULL_SEG_LNA_PON, GPIO_OUT_ONE) : (%d)\n", ret);
        msWait(10);

        ret = hwPowerOn(MT6323_POWER_LDO_VGP2, VOL_2800, "2V8_DTV_LNA");    // LNA power On
        print_log(0, "[1seg][MTK] hwPowerOn MT6323_POWER_LNA_VGP2(%d)\n", ret);
        msWait(10);
    }
#endif //defined(MTK_PMIC_LNA)
...
void tunerbb_drv_hw_deinit(void)
{
    ...
    if(lge_get_board_revno() == HW_REV_B)
    {
        ...
        ret = hwPowerDown(MT6323_POWER_LDO_VGP2, "2V8_DTV_LNA");    // LNA power Down
        print_log(0, "[1seg][MTK] hwPowerDown MT6323_POWER_LNA_VGP2(%d)\n", ret);
    }
#endif //defined(MTK_PMIC_LNA)
...
static int broadcast_spi_remove(struct spi_device *spi)
{
    ...
    // mask
    //mt_eint_mask(CUST_EINT_DTV_NUM);
#else //defined(CONFIG_ARCH_MT6582) || defined(CONFIG_ARCH_MT6592)// MediaTek platform
        free_irq(GPIO_ISDBT_IRQ, NULL);
#endif //defined(CONFIG_ARCH_MT6582) || defined(CONFIG_ARCH_MT6592)// MediaTek platform
