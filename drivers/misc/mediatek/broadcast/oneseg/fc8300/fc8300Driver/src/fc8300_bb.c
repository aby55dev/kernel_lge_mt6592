...
s32 fc8300_scan_status(HANDLE handle, DEVICEID devid)
{
	...
	for (i = 0; i < ifagc_timeout; i++) {
		bbm_byte_read(handle, DIV_MASTER, 0x3025, &a);
//		print_log(handle, "[FC8300] ifagc_timeout 0x%x cnt:%d\n", a, i);
	...
	for (; i < ofdm_timeout; i++) {
		bbm_byte_read(handle, DIV_MASTER, 0x3025, &a);
//		print_log(handle, "[FC8300] ofdm_timeout 0x%x cnt:%d\n", a, i);
	...
	for (; i < ffs_lock_timeout; i++) {
		bbm_byte_read(handle, DIV_MASTER, 0x3026, &a);
//		print_log(handle, "[FC8300] ffs_lock_timeout 0x%x cnt:%d\n", a, i);
	...
	for (i = 0; i < cfs_timeout; i++) {
		bbm_byte_read(handle, DIV_MASTER, 0x3025, &a);
//		print_log(handle, "[FC8300] cfs_timeout 0x%x cnt:%d\n", a, i);
	...
	bbm_byte_read(handle, DIV_MASTER, 0x2023, &a);
//	print_log(handle, "[FC8300] cfs_timeout2 0x%x cnt:%d\n", a, i);
	...
	for (i = 0; i < tmcc_timeout; i++) {
		bbm_byte_read(handle, DIV_MASTER, 0x3026, &a);
//		print_log(handle, "[FC8300] tmcc_timeout 0x%x cnt:%d\n", a, i);
	...
	for (i = 0; i < ts_err_free_timeout; i++) {
		bbm_byte_read(handle, DIV_MASTER, 0x50c5, &a);
//		print_log(handle, "[FC8300] ts_err_free_timeout 0x%x cnt:%d\n", a, i);
