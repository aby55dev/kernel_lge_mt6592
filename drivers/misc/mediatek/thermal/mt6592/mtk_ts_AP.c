...
#define AUX_XP_NTC 13
#endif

#if 1//def CONFIG_MACH_LGE
static int g_RAP_pull_up_R = 20000;
static int g_TAP_over_critical_low = 1135000;
static int g_RAP_pull_up_voltage = 1800;
static int g_RAP_ntc_table = 6;				// NCP15WF104F03RC + 100k Pull-Down
static int g_RAP_ADC_channel = AUX_XP_NTC;	// LGE use AUX_XP (13)
#else /* MTK Original */
