...
typedef struct acute_data{
    MUINT16 max_fps;
    MUINT32 pclk;
    MUINT16 line_length;
    MUINT16 frame_length;
    MUINT16 line_pixel;
    MUINT16 active_height;
}SENSOR_INFO_FOR_ACUTE;
...
typedef enum {
    ...
    SENSOR_FEATURE_GET_SENSOR_INFO_FOR_ACUTE, //[LGE_UPDATE][yonghwan.lym@lge.com][2015-04-01] add Interface(sensor information) for ACUTE
    SENSOR_FEATURE_MAX
