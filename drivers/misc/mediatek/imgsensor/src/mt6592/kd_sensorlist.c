...
//[LGE_UPDATE_S][yonghwan.lym@lge.com][2015-04-07] eeprom enable(common & s5k3l2xx)
/*******************************************************************************
 * iBurstReadRegI2C
 ********************************************************************************/
...
//[LGE_UPDATE_E][yonghwan.lym@lge.com][2015-04-07] eeprom enable(common & s5k3l2xx)
...
inline static int  adopt_CAMERA_HW_FeatureControl(void *pBuf)
{
	...
	switch (pFeatureCtrl->FeatureId)
	{
        ...
        case SENSOR_FEATURE_GET_SENSOR_INFO_FOR_ACUTE: //[LGE_UPDATE][yonghwan.lym@lge.com][2015-04-01] add Interface(sensor information) for ACUTE
            //
...
static int CAMERA_HW_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    //set I2C clock rate
    g_pstI2Cclient->timing = 400;//400k //LGE_UPDATE [youmi.jun@lge.com] 2015/03/06, Increase I2C clock (200kHz->400kHz)
    spin_unlock(&kdsensor_drv_lock);
