...
static int s4DW9718AF_WriteReg(u16 a_u2Data)
{
    ...
    udelay(30); //[LGE_UPDATE][yonghwan.lym@lge.com][2014-08-07] AF algorithm - remove the breakDownSteps function.
...
//[LGE_UPDATE_S] [kipo.yun@lge.com] [2014-12-13] Y50 Y70 Booting I2C Error Delete
 ...
 #endif  
//[LGE_UPDATE_ES] [kipo.yun@lge.com] [2014-12-13] Y50 Y70 Booting I2C Error Delete 
    if (g_s4DW9718AF_Opened)
    {
