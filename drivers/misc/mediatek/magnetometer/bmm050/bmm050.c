...
#if defined(CONFIG_MTK_AUTO_DETECT_MAGNETOMETER)
	if(err = bmm050_create_attr(&(msensor_init_info.platform_diver_addr->driver)))
	{
...
#if defined(CONFIG_MTK_AUTO_DETECT_MAGNETOMETER)
	if(bmm050_delete_attr(&(msensor_init_info.platform_diver_addr->driver)))
	{
...
static int __init bmm050_init(void)
{
	...
	{
		MSE_ERR("HW REV_A : bmm050 init FAIL\n");
		return -ENODEV;
	}
#endif
