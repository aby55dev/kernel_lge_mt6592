...
#include <linux/device.h>    //LGE_UPDATE [youmi.jun@lge.com] 2015/4/13, check module vendor_id
...
//LGE_UPDATE_S [youmi.jun@lge.com] 2015/4/13, check module vendor_id
...
//LGE_UPDATE_E [youmi.jun@lge.com] 2015/4/13, check module vendor_id
...
//LGE_UPDATE_S [youmi.jun@lge.com] 2015/4/13, check module vendor_id
    {
        uint16_t moduleId = 0;
        proxy_i2c_e2p_read(MODULE_VENDOR_ID, &moduleId, 2);
        main_cam_module_id =  moduleId >> 8;
    }
//LGE_UPDATE_E [youmi.jun@lge.com] 2015/4/13, check module vendor_id
...
//LGE_UPDATE_S [youmi.jun@lge.com] 2015/4/13, check module vendor_id
    {
        ...
        VL6180ADB("[VL6180] create vendor_id + \n");
