...
#if defined(CONFIG_LGE_AUTO_DETECT_ACCELEROMETER)
#include "../../accelerometer/gsensor_device_check.h" 
#endif
#if defined(CONFIG_LGE_AUTO_DETECT_MAGNETOMETER)
#include "../../magnetometer/msensor_device_check.h" 
#endif

#define SENSOR_INVALID_VALUE -1
#define MAX_CHOOSE_G_NUM 2
#define MAX_CHOOSE_M_NUM 2
...
struct sensor_init_info* gsensor_init_list[MAX_CHOOSE_G_NUM]= {0}; //modified
#endif
#if defined(CONFIG_MTK_AUTO_DETECT_MAGNETOMETER)
static char msensor_name[25];
struct sensor_init_info* msensor_init_list[MAX_CHOOSE_M_NUM]= {0}; //modified
#endif
