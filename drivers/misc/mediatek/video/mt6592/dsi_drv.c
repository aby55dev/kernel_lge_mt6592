...
void DSI_enter_ULPS_sw(void)
{    
    unsigned int pll_clock, ssc_disable;

    printk("DSI_enter_ULPS_sw \n");

    OUTREGBIT(DSI_PHY_LCCON_REG, DSI_REG->DSI_PHY_LCCON, LC_HS_TX_EN, 0);
    OUTREGBIT(DSI_COM_CTRL_REG, DSI_REG->DSI_COM_CTRL, DSI_EN, 0);
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0xf << 26) | (0xf << 20) | (0xf << 14) | (0xf << 7) | (0xf));
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL, 0x01);
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0xf << 26) | (0xf << 20) | (0xf << 14) | (0xf << 7) | (0xf));

    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x7 << 26) | (0x7 << 20) | (0x7 << 14) | (0x7 << 7) | (0xf));// N : 0 P : 1   // clk 11
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x3 << 26) | (0x3 << 20) | (0x3 << 14) | (0x3 << 7) | (0x7));// N : 0 : p : 0 // clk 10
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0xb << 26) | (0xb << 20) | (0xb << 14) | (0xb << 7) | (0x3));// N : 1 : P : 0
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x3 << 26) | (0x3 << 20) | (0x3 << 14) | (0x3 << 7) | (0x3));// N : 0 : p : 0
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0xb << 26) | (0xb << 20) | (0xb << 14) | (0xb << 7) | (0x3));// N : 1 : P : 0
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x3 << 26) | (0x3 << 20) | (0x3 << 14) | (0x3 << 7) | (0x3));// N : 0 : p : 0
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0xb << 26) | (0xb << 20) | (0xb << 14) | (0xb << 7) | (0x3));// N : 1 : P : 0
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x3 << 26) | (0x3 << 20) | (0x3 << 14) | (0x3 << 7) | (0x3));// N : 0 : p : 0
    ...
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x3 << 26) | (0x3 << 20) | (0x3 << 14) | (0x3 << 7) | (0x3));// N : 0 : p : 0  
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x7 << 26) | (0x7 << 20) | (0x7 << 14) | (0x7 << 7) | (0x3));// N : 0 P : 1
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x3 << 26) | (0x3 << 20) | (0x3 << 14) | (0x3 << 7) | (0x3));// N : 0 : p : 0
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x7 << 26) | (0x7 << 20) | (0x7 << 14) | (0x7 << 7) | (0x3));// N : 0 P : 1
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x3 << 26) | (0x3 << 20) | (0x3 << 14) | (0x3 << 7) | (0x3));// N : 0 : p : 0
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x7 << 26) | (0x7 << 20) | (0x7 << 14) | (0x7 << 7) | (0x3));// N : 0 P : 1
...
void DSI_exit_ULPS_sw(void)
{
    printk("DSI_exit_ULPS_sw\n");
    
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL, 0x01);
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x7 << 26) | (0x7 << 20) | (0x7 << 14) | (0x7 << 7) | (0x7));
    mdelay(1);
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0xf << 26) | (0xf << 20) | (0xf << 14) | (0xf << 7) | (0xf));
    mdelay(1);
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL, 0x0);
    OUTREGBIT(DSI_COM_CTRL_REG, DSI_REG->DSI_COM_CTRL, DSI_EN, 1);    
}
...
void DSI_change_mode(DSI_STATUS_FOR_MIX_MODE status)
{
    ...
    {            
        case DSI_INCELL_MIX_MODE:
            if (dsi_incell_mix_mode_status == DSI_INCELL_SUSPEND_MODE)
            {
                DSI_MixMode_Start();
            }    
            else
