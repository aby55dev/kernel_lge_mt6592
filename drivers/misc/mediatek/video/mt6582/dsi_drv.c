...
void DSI_enter_ULPS_sw(void)
{
    ...
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x3 << 26) | (0x3 << 20) | (0x3 << 14) | (0x3 << 7) | (0x3));
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0xb << 26) | (0xb << 20) | (0xb << 14) | (0xb << 7) | (0xb));
    OUTREG32(&DSI_PHY_REG->MIPITX_DSI_SW_CTRL_CON0, (0x3 << 26) | (0x3 << 20) | (0x3 << 14) | (0x3 << 7) | (0x3));
