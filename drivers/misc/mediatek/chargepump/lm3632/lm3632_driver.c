...
#if defined (CONFIG_LEDS_DEVICE_TFL404040RO) || defined (CONFIG_LEDS_DEVICE_EAV62991901)
...
#if defined (CONFIG_LEDS_DEVICE_TFL404040RO)
unsigned char bright_arr[] = {  // array index max 100, value under 255
        10, 10, 10, 10, 11, 11, 11, 11, 12, 12, 12, 12, 13, 13, 13, 14, 14, 14, 14, 15,  // 19
        15, 16, 16, 17, 17, 18, 19, 19, 20, 21, 22, 23, 23, 24, 25, 26, 27, 27, 28, 29,  // 39
        30, 32, 33, 35, 36, 38, 40, 42, 44, 46, 48, 50, 52, 53, 54, 55, 56, 57, 58, 59,  // 59
        60, 62, 64, 66, 68, 70, 72, 74, 76, 78, 80, 82, 84, 86, 88, 90, 92, 94, 96, 98,  // 79
        100, 103, 106, 109, 112, 115, 118, 121, 124, 127, 130, 133, 136, 139, 142, 145, 148, 151, 154, 157, 160  // 100
    };
#elif defined (CONFIG_LEDS_DEVICE_EAV62991901)
unsigned char bright_arr[] = {  // array index max 100, value under 255
...
#if defined (CONFIG_LEDS_DEVICE_EAV62991901) //|| defined (CONFIG_LEDS_DEVICE_TFL404040RO) 
...
#if defined (CONFIG_LEDS_DEVICE_TFL404040RO)  // DSV FD toggle for LCD remain current out
            // set fd to enable
            data = 0x19;
