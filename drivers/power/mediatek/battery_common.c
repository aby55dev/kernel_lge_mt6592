...
extern kal_bool chargin_usb_type_factory;
#endif
...
static void battery_update(struct battery_data *bat_data)
{
...
#ifdef CONFIG_LGE_PM_SOC_SCALE
	{
		...
		{
			/* clear rtc fg soc when battery is not exist */
			static int invalid_soc = 0;
...
CHARGER_TYPE mt_charger_type_detection(void)
{
	...
	if ((BMT_status.charger_type == CHARGER_UNKNOWN) &&
		...
		BMT_status.charger_type = CHR_Type_num;
#ifdef CONFIG_LGE_CABLE_ID_DETECT
        BMT_status.factory_cable = chargin_usb_type_factory;
#endif
